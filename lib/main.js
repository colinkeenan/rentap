...
var INIT0 = [["Nothing","","","","","","","","","","","","","","","","","","","","","Nothing to See Here"]];
...
loadData.PageMod({
   ...
   onAttach: function onAttach(worker) {
      function arrayofcsvToArrayofArrays(arrayofcsv) {
         ...
         if (typeof(arrayofcsv) != 'undefined') {
            for(var i=0; i<arrayofcsv.length; i++) {
               if (typeof(arrayofcsv[i]) != 'undefined' && arrayofcsv[i] != null) {
                  arrayofArrays[i] = CSV.csvToArray(arrayofcsv[i])[0];
               } else if (typeof(arrayofcsv[i]) == null) {
                  if (i == 0) {
                     arrayofArrays = INIT0;
                  } else {
      ...
      var test = arrayofcsvToArrayofArrays();
      console.log(test);
      var csvtest
      var test = arrayofcsvToArrayofArrays(csvtest);
      console.log(test);
      csvtest = [];
      var test = arrayofcsvToArrayofArrays(csvtest);
      console.log(test);
      ...
      var test = arrayofcsvToArrayofArrays(csvtest);
      console.log(test);
      csvtest = csvtest.push('"Nothing to See Here","","","","","","","","","","","","","","","","","","","","",""');
      var test = arrayofcsvToArrayofArrays(csvtest);
      console.log(test);
