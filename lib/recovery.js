...
exports.storage = recovery.require('sdk/simple-storage').storage;
exports.prefs = recovery.require('sdk/simple-prefs').prefs;
exports.passwords = recovery.require('sdk/passwords');
